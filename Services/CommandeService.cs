...
//         public async Task<ServiceResult<Commande>> UpdateCommandeAsync(Commande commande, ServiceResult<Commande> serviceResult)
//         {
//             if (commande == null)
//             {
//                 return ServiceResult<Commande>.Error("La commande ne peut pas être null.");
...
//                 // return serviceResult.Error("Une erreur est survenue lors de la mise à jour de la commande.");
//             }
//         }
...
//             // existingCommande.DateCommande = newCommande.DateCommande;
//             existingCommande.Montant = newCommande.Montant;
//             existingCommande.Produit = newCommande.Produit;
//         }

//         public Task<ServiceResult<Commande>> UpdateCommandeAsync(Commande commande)
//         {
...
//     {
//         internal static ServiceResult<Commande> Error(string v)
//         {
//             throw new NotImplementedException();
//         }

//         internal static ServiceResult<Commande> Success(Commande commande, string v)
//         {
//             throw new NotImplementedException();
//         }

//         internal static ServiceResult<bool> Success(bool v1, string v2)
//         {
//             throw new NotImplementedException();
//         }
//     }
